...
/* NIAKVIO_PROVIDER_ID:allmovieland */
...
/* STARTFIX:PROVIDER.ALLMOVIELAND.CONFIG.V1 */
/* FIXDATA:PROVIDER.ALLMOVIELAND.CONFIG.V1: */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"🌍 AllMovieLand","domainSubstitutions":{},"externalIdentityPlan":[],"fixedApi":null,"identityInput":{"mode":"catalog_search","requiredFields":["title","mediaType"],"requiresTmdbBeforeRun":true},"knownSite":"https://allmovieland.art","modelSchemaVersion":4,"observedUrls":["https://allmovieland.you/","https://allmovieland.art"],"officialApi":null,"officialHub":null,"officialSite":"https://allmovieland.art","origins":["https://allmovieland.art","https://allmovieland.you"],"outputLanguageRules":[],"outputUrlHostRewrites":[],"proofDetailBases":[],"proofProtectedHosts":[],"proofSearchBases":[],"providerId":"allmovieland","providerValuePlan":[],"reconstructionState":"learning-clean-seed","routePlanVersion":3,"routeProofVersion":5,"routes":["/index.php?story={query}&do=search&subaction=search","/play/{id}","/playlist/{id}.txt"],"runtimeDiscovery":false,"runtimeRole":"reader","searchRequestPlan":[],"sourceRuntimeFamily":"catalogue-html","strategy":"html_scraper","strictHtmlIdentity":false,"strictIdentity":false,"supportedTypes":["movie","tv"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
/* CLOSEFIX:PROVIDER.ALLMOVIELAND.CONFIG.V1 */
/* STARTFIX:PROVIDER.ALLMOVIELAND.RUNTIME.V1 */
/* FIXDATA:PROVIDER.ALLMOVIELAND.RUNTIME.V1: */
...
function q(args){var first=args[0],o=first&&typeof first==="object"&&!Array.isArray(first)?first:null,ctx={};try{ctx=g&&g.__nuvioMediaContext||{}}catch(_e){}var md=(o&&(o.tmdbMetadata||o.tmdb_metadata||o.metadata))||ctx.tmdbMetadata||{};if(md&&md.state==="ok"&&md.metadata)md=md.metadata;var type=s((o&&(o.canonicalMediaType||o.mediaType||o.type))||ctx.canonicalMediaType||args[1]||"movie").toLowerCase();if(type!=="movie"&&type!=="tv")return null;var title=s((o&&o.title)||md.title||md.name||ctx.title),date=s(md.release_date||md.first_air_date||(o&&o.year)||ctx.year),year=Number(date.slice(0,4))||Number(o&&o.year)||0,imdb=s((o&&(o.imdbId||o.imdb_id))||md.imdb_id||ctx.imdbId||ctx.imdb_id);return{type:type,title:title,year:year,imdbId:imdb,season:Number((o&&o.season)!=null?o.season:args[2])||1,episode:Number((o&&o.episode)!=null?o.episode:args[3])||1}}
...
function playerData(html){var body=s(html).replace(/\\\//g,"/"),d=/AwsIndStreamDomain[\s\S]{0,100}?["'](https?:\/\/[^"']+)["']/i.exec(body),raw="",patterns=[/\bsrc\s*:\s*["']([^"']+)["']/i,/data-src=["']([^"']+)["']/i,/\/play\/([a-z0-9._~-]+)(?:[?&#"'\s]|$)/i];for(var i=0;i<patterns.length&&!raw;i++){var m=patterns[i].exec(body);if(m)raw=s(m[1])}if(raw.indexOf("/play/")>=0)raw=raw.split("/play/").pop().split(/[?#/]/)[0];return{domain:d?s(d[1]).replace(/\/$/,""):"",id:raw}}
function playerScripts(html,base){var out=[],re=/<script\b[^>]*src=["']([^"']*player[^"']*\.js[^"']*)["']/gi,m;while((m=re.exec(html))&&out.length<4){var u=abs(m[1],base);if(u&&!out.includes(u))out.push(u)}return out}
function playerDomain(js){var body=s(js).replace(/\\\//g,"/"),m=/AwsIndStreamDomain[\s\S]{0,100}?["'](https?:\/\/[^"']+)["']/i.exec(body);return m?s(m[1]).replace(/\/$/,""):""}
...
function quality(v){var m=s(v).match(/(2160|1440|1080|720|480|360)p?/i);return m?m[1]+"p":""}
async function fallbackDomain(detail,site){var scripts=playerScripts(detail.body,detail.url);try{var host=new URL(site).hostname;if(host)scripts.push("https://"+host+".link/player.js?v=60%20128")}catch(_e){}for(var i=0;i<scripts.length&&i<5;i++){try{var js=await text(scripts[i],{referer:detail.url}),domain=playerDomain(js.body);if(domain)return domain}catch(_e){}}return""}
async function resolveDetail(url,site,meta){var detail=await text(url),pd=playerData(detail.body);if(!pd.domain)pd.domain=await fallbackDomain(detail,site);if(!pd.id&&/^tt\d+$/i.test(meta.imdbId))pd.id=meta.imdbId;if(!pd.domain||!pd.id)return[];var embed=pd.domain+"/play/"+encodeURIComponent(pd.id),page=await text(embed,{referer:url}),cfg=p3(page.body);if(!cfg||!cfg.file||!cfg.key)return[];var listUrl=/^https?:/i.test(s(cfg.file))?s(cfg.file):abs(s(cfg.file),pd.domain),list=await text(listUrl,{method:"POST",referer:embed,headers:{"X-CSRF-TOKEN":s(cfg.key)}}),rows=files(json(list.body),meta),out=[];for(var i=0;i<rows.length&&out.length<8;i++){var f=s(rows[i].file).replace(/^~/,""),u=pd.domain+"/playlist/"+encodeURIComponent(f)+".txt";try{var r=await text(u,{method:"POST",referer:embed,headers:{"X-CSRF-TOKEN":s(cfg.key)}}),media=s(r.body);if(!/^https?:\/\//i.test(media))continue;var ql=quality(rows[i].title),row={name:c.name,title:c.name,url:media,provider:c.provider,headers:{Referer:pd.domain+"/","User-Agent":headers()["User-Agent"]}};if(ql)row.quality=ql;out.push(row)}catch(_e){}}return out}
async function run(args){var meta=q(args);if(!meta||!meta.title)return[];for(var b=0;b<c.sites.length;b++){var base=c.sites[b];try{var search=base+"/index.php?story="+encodeURIComponent(meta.title)+"&do=search&subaction=search",page=await text(search),urls=candidates(page.body,page.url||search,meta);for(var i=0;i<urls.length;i++){var out=await resolveDetail(urls[i],base,meta);if(out.length)return out}}catch(_e){}}return[]}
...
})(typeof globalThis!=="undefined"?globalThis:this,{"sites":["https://allmovieland.to","https://allmovieland.art","https://allmovieland.one","https://allmovieland.io"],"name":"AllMovieLand","provider":"allmovieland"});
/* CLOSEFIX:PROVIDER.ALLMOVIELAND.RUNTIME.V1 */
/* NUVIO_GLOBAL_CORE_START_BOUNDARY_V1 */
/* STARTFIX:CORE.CATALOGUE_ALIAS_RECOVERY.V2 */
/* FIXDATA:CORE.CATALOGUE_ALIAS_RECOVERY.V2: */
/* NUVIO_GLOBAL_CATALOGUE_ALIAS_RECOVERY_V2:96e0f2881f03 */
;(function(g,c){"use strict";
...
/* FIXDATA:CORE.RUNTIME_MEDIA_SAFETY.V4: */
/* NUVIO_GLOBAL_RUNTIME_MEDIA_SAFETY_V1:a1fa57f78809 */
;(function(g,c){
  "use strict";
  function s(v){return String(v==null?"":v).trim()}
  function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
  ...
  var ok=false;try{if(typeof module!=="undefined"&&module.exports)ok=install(module.exports,"getStreams")}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"allmovieland","capabilityStrategy":"html_scraper","requestTypeAliases":{},"timeoutMs":6500,"tmdbTimeoutMs":4500,"maxRows":4,"minDurationRatio":0.55,"maxDurationRatio":1.8,"durationIdentity":true,"strictPlayback":false,"implementationRevision":"field-safety-v8-media-only-p2p-vod-duration"});
...
/* FIXDATA:CORE.STREAM_IDENTITY.V1: */
/* NUVIO_GLOBAL_STREAM_IDENTITY_V1:a91699436bfa */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).replace(/\\\//g,"/").trim()}
function norm(v){try{return s(v).normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/[^a-z0-9]+/g," ").trim()}catch(_e){return s(v).toLowerCase()}}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"allmovieland","tmdbRuntimeKeyRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"cross-client-shared-tmdb-owner-zero-episodic-year-v11","catalogueYearPolicy":"movie-only"});
...
/* FIXDATA:CORE.STREAM_PRESENTATION.V1: */
/* NUVIO_GLOBAL_STREAM_PRESENTATION_V1:6490508ae86c */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).trim()}
function meaningful(v){var x=s(v);return x&&!/^(?:unknown|inconnue?|n\/?a|null|undefined|none|-+)$/i.test(x)}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"allmovieland","providerLanguageMode":"vo","languageFallback":"VO","tmdbCoreCapabilityRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"all-providers-client-projection-name-mirror-v20"});
/* CLOSEFIX:CORE.STREAM_PRESENTATION.V1 */
/* STARTFIX:CORE.PROVIDER_BRANDING.V1 */
/* FIXDATA:CORE.PROVIDER_BRANDING.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoicG9zdC1wcmVzZW50YXRpb24tbG9zc2xlc3Mtc291cmNlLWxhYmVsLXY4IiwicHJvdmlkZXJFbW9qaSI6IvCfjI0iLCJwcm92aWRlcklkIjoiYWxsbW92aWVsYW5kIiwicHJvdmlkZXJOYW1lIjoiQWxsTW92aWVMYW5kIn0= */
/* NUVIO_GLOBAL_PROVIDER_BRANDING_V1:c09bbbac15af */
;(function(g,c){"use strict";
function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
function rebuild(v,x,list){if(x.key===null)return list;var o=Object.assign({},v);o[x.key]=list;return o}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"allmovieland","providerName":"AllMovieLand","providerEmoji":"🌍","implementationRevision":"post-presentation-lossless-source-label-v8"});
