...
/* STARTFIX:PROVIDER.STREAMZO.CONFIG.V1 */
/* FIXDATA:PROVIDER.STREAMZO.CONFIG.V1: */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"🌊 StreamZo","domainSubstitutions":{},"externalIdentityPlan":[],"fixedApi":null,"identityInput":{"mode":"catalog_search","requiredFields":["title","year","mediaType"],"requiresTmdbBeforeRun":true},"knownSite":"https://streamzo.fr","modelSchemaVersion":4,"observedUrls":["https://streamzo.fr/","https://streamzo.fr"],"officialApi":null,"officialHub":null,"officialSite":"https://streamzo.fr","origins":["https://streamzo.fr","https://video.sibnet.ru","https://vidmoly.me","https://fsvid.lol","https://vidzy.live","https://streamtape.com","https://sendvid.com","https://www.myvi.ru","https://younetu.org","https://vidoza.net","https://lecteurvideo.com","https://up4fun.top","https://kitsu.io"],"outputLanguageRules":[],"outputUrlHostRewrites":[],"proofDetailBases":[],"proofProtectedHosts":["streamzo.fr"],"proofSearchBases":[],"providerId":"streamzo","providerValuePlan":[],"reconstructionState":"learning-clean-seed","routePlanVersion":3,"routeProofVersion":5,"routes":[],"runtimeDiscovery":false,"runtimeRole":"reader","searchRequestPlan":[],"sourceRuntimeFamily":"catalogue-html","strategy":"mixed_embed_resolver","strictHtmlIdentity":false,"strictIdentity":false,"supportedTypes":["movie","tv","anime"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
/* CLOSEFIX:PROVIDER.STREAMZO.CONFIG.V1 */
...
/* FIXDATA:CORE.CATALOGUE_ALIAS_RECOVERY.V2: */
/* NUVIO_GLOBAL_CATALOGUE_ALIAS_RECOVERY_V2:025bf4ab816d */
...
})(typeof globalThis!=="undefined"?globalThis:this,{"baseUrl":"","providerName":"streamzo","maxAliases":4,"maxCandidates":8,"maxPlayers":8,"timeoutMs":7000,"budgetMs":45000,"languageHint":"","searchPaths":[],"directPaths":["/{slug}","/series/{slug}"],"detailIdAttributes":[],"mirrorRoutes":[],"mirrorTypes":[],"mirrorAllowEpisodic":false,"authoritative":true,"implementationRevision":"authoritative-recovery-v13-positive-output-only"});
/* CLOSEFIX:CORE.CATALOGUE_ALIAS_RECOVERY.V2 */
/* STARTFIX:CORE.MEDIA_ENRICHMENT.V1 */
/* FIXDATA:CORE.MEDIA_ENRICHMENT.V1: */
/* NUVIO_GLOBAL_MEDIA_ENRICHMENT_V1:aca9d8a55906 */
;(function(g,c){"use strict";
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports)ok=install(module.exports,"getStreams")}catch(_){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_){}
})(typeof globalThis!=="undefined"?globalThis:this,{"maxRows":6,"maxDepth":2,"maxCandidates":10,"timeoutMs":6500,"preserveOriginal":true,"defaultUserAgent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36","implementationRevision":"scoped-playback-context-v8-media-first-candidates"});
/* CLOSEFIX:CORE.MEDIA_ENRICHMENT.V1 */
/* STARTFIX:CORE.RUNTIME_MEDIA_SAFETY.V4 */
/* FIXDATA:CORE.RUNTIME_MEDIA_SAFETY.V4: */
/* NUVIO_GLOBAL_RUNTIME_MEDIA_SAFETY_V1:d153ad5f2cc4 */
;(function(g,c){
  "use strict";
...
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"streamzo","capabilityStrategy":"mixed_embed_resolver","requestTypeAliases":{"anime":"tv"},"timeoutMs":6500,"tmdbTimeoutMs":4500,"maxRows":4,"minDurationRatio":0.55,"maxDurationRatio":1.8,"durationIdentity":true,"strictPlayback":false,"implementationRevision":"field-safety-v8-media-only-p2p-vod-duration"});
/* CLOSEFIX:CORE.RUNTIME_MEDIA_SAFETY.V4 */
/* STARTFIX:CORE.HLS_RUNTIME_INTEGRITY.V1 */
/* FIXDATA:CORE.HLS_RUNTIME_INTEGRITY.V1: */
/* NUVIO_HLS_RUNTIME_INTEGRITY_V1:aa5275a730c1 */
;(function(g,config){
  "use strict";
  ...
  install();
})(typeof globalThis!=="undefined"?globalThis:this,{"timeoutMs":9000,"maxChildren":3,"maxRecoveryPages":6,"maxRecoveryCandidates":18,"implementationRevision":"final-output-order-v6-native-budget-owned","probeAllUrls":true,"failClosedUnknown":false});
...
/* FIXDATA:CORE.STREAM_IDENTITY.V1: */
/* NUVIO_GLOBAL_STREAM_IDENTITY_V1:7c06b147d1a5 */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).replace(/\\\//g,"/").trim()}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"streamzo","tmdbRuntimeKeyRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"cross-client-shared-tmdb-owner-zero-episodic-year-v11","catalogueYearPolicy":"movie-only"});
...
/* FIXDATA:CORE.STREAM_PRESENTATION.V1: */
/* NUVIO_GLOBAL_STREAM_PRESENTATION_V1:acff3125926f */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).trim()}
function meaningful(v){var x=s(v);return x&&!/^(?:unknown|inconnue?|n\/?a|null|undefined|none|-+)$/i.test(x)}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"streamzo","providerLanguageMode":"vf","languageFallback":"VF","tmdbCoreCapabilityRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"all-providers-client-projection-name-mirror-v20"});
/* CLOSEFIX:CORE.STREAM_PRESENTATION.V1 */
/* STARTFIX:CORE.PROVIDER_BRANDING.V1 */
/* FIXDATA:CORE.PROVIDER_BRANDING.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoicG9zdC1wcmVzZW50YXRpb24tbG9zc2xlc3Mtc291cmNlLWxhYmVsLXY4IiwicHJvdmlkZXJFbW9qaSI6IvCfjIoiLCJwcm92aWRlcklkIjoic3RyZWFtem8iLCJwcm92aWRlck5hbWUiOiJTdHJlYW1abyJ9 */
/* NUVIO_GLOBAL_PROVIDER_BRANDING_V1:8f92c43cff8a */
;(function(g,c){"use strict";
function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
function rebuild(v,x,list){if(x.key===null)return list;var o=Object.assign({},v);o[x.key]=list;return o}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"streamzo","providerName":"StreamZo","providerEmoji":"🌊","implementationRevision":"post-presentation-lossless-source-label-v8"});
