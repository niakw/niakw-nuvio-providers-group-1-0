...
/* STARTFIX:PROVIDER.VIDEASY.CONFIG.V1 */
/* FIXDATA:PROVIDER.VIDEASY.CONFIG.V1:eyJhcGlSZWNpcGUiOm51bGwsImF1dGhvcmluZyI6Im5pYWt2aW8tb3duZWQtdjMiLCJkaXNwbGF5TmFtZSI6IuKWtu- */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"▶️ VidEasy","domainSubstitutions":{},"externalIdentityPlan":[],"fixedApi":null,"identityInput":{"mode":"catalog_search","requiredFields":["title","year","mediaType"],"requiresTmdbBeforeRun":true},"knownSite":"https://player.videasy.to","modelSchemaVersion":4,"observedUrls":["https://www.vidking.net/","https://api.speedracelight.com/","https://player.videasy.to","https://api.speedracelight.com"],"officialApi":"https://api.speedracelight.com","officialHub":"https://www.videasy.to/docs","officialSite":"https://player.videasy.to","origins":["https://player.videasy.to","https://www.videasy.to","https://api.speedracelight.com","https://www.vidking.net"],"outputLanguageRules":[],"outputUrlHostRewrites":[],"proofDetailBases":[],"proofProtectedHosts":[],"proofSearchBases":[],"providerId":"videasy","providerValuePlan":[],"reconstructionState":"learning-clean-seed","routePlanVersion":3,"routeProofVersion":5,"routes":[],"runtimeDiscovery":false,"runtimeRole":"reader","searchRequestPlan":[],"sourceRuntimeFamily":"tmdb-direct-api","strategy":"api_stream_resolver","strictHtmlIdentity":false,"strictIdentity":false,"supportedTypes":["movie","tv"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
/* CLOSEFIX:PROVIDER.VIDEASY.CONFIG.V1 */
/* STARTFIX:PROVIDER.VIDEASY.WINGS.V1 */
/* FIXDATA:PROVIDER.VIDEASY.WINGS.V1: */
/* NIAKVIO_VIDEASY_WINGS_V1 */
;(function(g,c){
  "use strict";
...
})(typeof globalThis!=="undefined"?globalThis:this,{"apiBase":"https://api.speedracelight.com","origin":"https://www.vidking.net","referer":"https://www.vidking.net/","userAgent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/122.0.0.0 Safari/537.36","providerId":"videasy","providerName":"VidEasy","installMarker":"__niakvioVidEasyWingsV1","endpoints":[{"label":"Hydrogen","path":"cdn/sources-with-title"},{"label":"Titanium","path":"tejo/sources-with-title"},{"label":"Oxygen","path":"neon2/sources-with-title"},{"label":"Lithium","path":"downloader2/sources-with-title"},{"label":"Krypton","path":"ym/sources-with-title"},{"label":"Carbon","path":"mb-flix/sources-with-title"},{"label":"Aluminium","path":"lamovie/sources-with-title"},{"label":"Nitrogen","path":"m4uhd/sources-with-title"},{"label":"Neon","path":"superflix/sources-with-title"},{"label":"Helium","path":"1movies/sources-with-title"}]});
/* CLOSEFIX:PROVIDER.VIDEASY.WINGS.V1 */
...
/* FIXDATA:CORE.RUNTIME_MEDIA_SAFETY.V4: */
/* NUVIO_GLOBAL_RUNTIME_MEDIA_SAFETY_V1:eada7a33ec6f */
;(function(g,c){
  "use strict";
  function s(v){return String(v==null?"":v).trim()}
  function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
...
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"videasy","capabilityStrategy":"api_stream_resolver","requestTypeAliases":{},"timeoutMs":6500,"tmdbTimeoutMs":4500,"maxRows":4,"minDurationRatio":0.55,"maxDurationRatio":1.8,"durationIdentity":true,"strictPlayback":false,"implementationRevision":"field-safety-v8-media-only-p2p-vod-duration"});
...
/* FIXDATA:CORE.STREAM_IDENTITY.V1:eyJjYXRhbG9ndWVZZWFyUG9saWN5IjoibW92aWUtb25seSIsImltcGxlbWVudGF0aW9uUmV2aXNpb24iOiJjcm9zcy1jbGllbnQtc2hhcmVkLXRtZGItb3duZXItemVyby1lcGlzb2RpYy15ZWFyLXYxMSIsInByb3ZpZGVySWQiOiJ2aWRlYXN5IiwidG1kYlJ1bnRpbWVLZXlSZXF1aXJlZCI6dHJ1ZSwidG1kYlRpbWVvdXRNcyI6MTIwMH0= */
/* NUVIO_GLOBAL_STREAM_IDENTITY_V1:a94184b50f32 */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).replace(/\\\//g,"/").trim()}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"videasy","tmdbRuntimeKeyRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"cross-client-shared-tmdb-owner-zero-episodic-year-v11","catalogueYearPolicy":"movie-only"});
...
/* FIXDATA:CORE.STREAM_PRESENTATION.V1: */
/* NUVIO_GLOBAL_STREAM_PRESENTATION_V1:7dd35910966b */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).trim()}
function meaningful(v){var x=s(v);return x&&!/^(?:unknown|inconnue?|n\/?a|null|undefined|none|-+)$/i.test(x)}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"videasy","providerLanguageMode":"vo","languageFallback":"VO","tmdbCoreCapabilityRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"all-providers-client-projection-name-mirror-v20"});
/* CLOSEFIX:CORE.STREAM_PRESENTATION.V1 */
/* STARTFIX:CORE.PROVIDER_BRANDING.V1 */
/* FIXDATA:CORE.PROVIDER_BRANDING.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoicG9zdC1wcmVzZW50YXRpb24tbG9zc2xlc3Mtc291cmNlLWxhYmVsLXY4IiwicHJvdmlkZXJFbW9qaSI6IuKWtu-4jyIsInByb3ZpZGVySWQiOiJ2aWRlYXN5IiwicHJvdmlkZXJOYW1lIjoiVmlkRWFzeSJ9 */
/* NUVIO_GLOBAL_PROVIDER_BRANDING_V1:385714ff7e15 */
;(function(g,c){"use strict";
function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
function rebuild(v,x,list){if(x.key===null)return list;var o=Object.assign({},v);o[x.key]=list;return o}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"videasy","providerName":"VidEasy","providerEmoji":"▶️","implementationRevision":"post-presentation-lossless-source-label-v8"});
