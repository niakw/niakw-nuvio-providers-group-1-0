...
/* STARTFIX:PROVIDER.ANIKOTOTV.CONFIG.V1 */
/* FIXDATA:PROVIDER.ANIKOTOTV.CONFIG.V1:__ */
const NIAKVIO_PROVIDER_MODEL = Object.freeze({"apiRecipe":null,"authoring":"niakvio-owned-v3","displayName":"📺 AnikotoTV","domainSubstitutions":{},"externalIdentityPlan":[],"fixedApi":null,"identityInput":{"mode":"catalog_search","requiredFields":["title","mediaType"],"requiresTmdbBeforeRun":true},"knownSite":"https://anikototv.to/home","modelSchemaVersion":4,"observedUrls":["https://api4.thetvdb.com/v4/search?query=","https://api4.thetvdb.com/v4/series/","https://api4.thetvdb.com/v4/login","https://aiometadata.elfhosted.com/stremio/80d082c4-6e99-4c97-a67d-3d9e242685ce/meta/series/","https://anikototv.to/home"],"officialApi":null,"officialHub":"https://streamingsiteshub.com/","officialSite":"https://anikototv.to/home","origins":["https://anikototv.to","https://streamingsiteshub.com","https://api4.thetvdb.com","https://aiometadata.elfhosted.com"],"outputLanguageRules":[],"outputUrlHostRewrites":[],"proofDetailBases":[],"proofProtectedHosts":[],"proofSearchBases":[],"providerId":"anikototv","providerValuePlan":[],"reconstructionState":"learning-clean-seed","routePlanVersion":3,"routeProofVersion":5,"routes":["/search?keyword={query}","/watch/{slug}","/ajax/episode/list/{id}","/ajax/server/list?servers={id}","/ajax/server?get={id}"],"runtimeDiscovery":false,"runtimeRole":"reader","searchRequestPlan":[],"sourceRuntimeFamily":"tmdb-direct-api","strategy":"mixed_embed_resolver","strictHtmlIdentity":false,"strictIdentity":false,"supportedTypes":["anime","movie"],"upstreamCodeEmbedded":false,"upstreamCodeExecuted":false});
/* CLOSEFIX:PROVIDER.ANIKOTOTV.CONFIG.V1 */
/* STARTFIX:PROVIDER.ANIKOTOTV.RUNTIME.V1 */
/* FIXDATA:PROVIDER.ANIKOTOTV.RUNTIME.V1: */
...
function h(ref,xhr,cookie){var out={"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 NiakVIO/3","Accept":"text/html,application/json,text/plain,*/*"};if(ref)out.Referer=ref;if(xhr)out["X-Requested-With"]="XMLHttpRequest";if(cookie)out.Cookie=cookie;return out}
async function get(url,ref,xhr,cookie){var r=await g.fetch(url,{headers:h(ref,xhr,cookie),credentials:"include",redirect:"follow"});if(!r||!r.ok)throw new Error("anikoto_http_"+String(r&&r.status||0));var set="";try{set=s(r.headers&&r.headers.get&&r.headers.get("set-cookie"))}catch(_e){}return{body:await r.text(),url:r.url||url,cookie:set?set.split(";",1)[0]:""}}
...
function results(html,meta){var out=[],re=/<a\b[^>]*href=["']([^"']*\/watch\/[^"']+)["'][^>]*>([\s\S]*?)<\/a>/gi,m;while((m=re.exec(html))&&out.length<120){var title=text(m[2]),sc=score(title,meta.title,meta.year);if(sc<32)continue;var tail=s(m[1]).split("/watch/").pop().split(/[?#]/)[0],slug=tail.split("/")[0];if(slug)out.push({slug:slug,score:sc,title:title})}out.sort(function(a,b){return b.score-a.score});var seen={},v=[];for(var i=0;i<out.length&&v.length<6;i++){if(!seen[out[i].slug]){seen[out[i].slug]=1;v.push(out[i])}}return v}
...
})(typeof globalThis!=="undefined"?globalThis:this,{"mirrors":["https://anikototv.to","https://anikoto.cz","https://anikoto.me","https://anikoto.net","https://anikototv.se"],"provider":"anikototv","name":"AnikotoTV"});
/* CLOSEFIX:PROVIDER.ANIKOTOTV.RUNTIME.V1 */
/* NUVIO_GLOBAL_CORE_START_BOUNDARY_V1 */
/* STARTFIX:CORE.CATALOGUE_ALIAS_RECOVERY.V2 */
/* FIXDATA:CORE.CATALOGUE_ALIAS_RECOVERY.V2: */
/* NUVIO_GLOBAL_CATALOGUE_ALIAS_RECOVERY_V2:83ae84936b04 */
;(function(g,c){"use strict";
...
/* FIXDATA:CORE.RUNTIME_MEDIA_SAFETY.V4: */
/* NUVIO_GLOBAL_RUNTIME_MEDIA_SAFETY_V1:354ff0216e7c */
;(function(g,c){
  "use strict";
  function s(v){return String(v==null?"":v).trim()}
  function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
  ...
  var ok=false;try{if(typeof module!=="undefined"&&module.exports)ok=install(module.exports,"getStreams")}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"anikototv","capabilityStrategy":"mixed_embed_resolver","requestTypeAliases":{},"timeoutMs":6500,"tmdbTimeoutMs":4500,"maxRows":4,"minDurationRatio":0.55,"maxDurationRatio":1.8,"durationIdentity":true,"strictPlayback":false,"implementationRevision":"field-safety-v8-media-only-p2p-vod-duration"});
...
/* FIXDATA:CORE.STREAM_IDENTITY.V1: */
/* NUVIO_GLOBAL_STREAM_IDENTITY_V1:0da08ecd6ed0 */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).replace(/\\\//g,"/").trim()}
function norm(v){try{return s(v).normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/[^a-z0-9]+/g," ").trim()}catch(_e){return s(v).toLowerCase()}}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"anikototv","tmdbRuntimeKeyRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"cross-client-shared-tmdb-owner-zero-episodic-year-v11","catalogueYearPolicy":"movie-only"});
/* CLOSEFIX:CORE.STREAM_IDENTITY.V1 */
/* STARTFIX:CORE.MEDIA_TYPE_RESOLUTION.V1 */
/* FIXDATA:CORE.MEDIA_TYPE_RESOLUTION.V1: */
/* NUVIO_GLOBAL_MEDIA_TYPE_RESOLUTION_V1:1a2ba26f49da */
...
})(typeof globalThis!=="undefined"?globalThis:this,{"timeoutMs":1800,"providerTimeoutMs":60000,"tvProviderTimeoutMs":60000,"supersedeSettleMs":1200,"semanticTypes":["anime","movie"],"requestTypeAliases":{},"revision":"tmdb-data-contract-launch-gate-v31-pre-network-semantic-gate"});
/* CLOSEFIX:CORE.MEDIA_TYPE_RESOLUTION.V1 */
/* STARTFIX:CORE.STREAM_PRESENTATION.V1 */
/* FIXDATA:CORE.STREAM_PRESENTATION.V1: */
/* NUVIO_GLOBAL_STREAM_PRESENTATION_V1:0b77bbee2e52 */
;(function(g,c){"use strict";
function s(v){return String(v==null?"":v).trim()}
function meaningful(v){var x=s(v);return x&&!/^(?:unknown|inconnue?|n\/?a|null|undefined|none|-+)$/i.test(x)}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"anikototv","providerLanguageMode":"vo","languageFallback":"VO","tmdbCoreCapabilityRequired":true,"tmdbTimeoutMs":1200,"implementationRevision":"all-providers-client-projection-name-mirror-v20"});
/* CLOSEFIX:CORE.STREAM_PRESENTATION.V1 */
/* STARTFIX:CORE.PROVIDER_BRANDING.V1 */
/* FIXDATA:CORE.PROVIDER_BRANDING.V1:eyJpbXBsZW1lbnRhdGlvblJldmlzaW9uIjoicG9zdC1wcmVzZW50YXRpb24tbG9zc2xlc3Mtc291cmNlLWxhYmVsLXY4IiwicHJvdmlkZXJFbW9qaSI6IvCfk7oiLCJwcm92aWRlcklkIjoiYW5pa290b3R2IiwicHJvdmlkZXJOYW1lIjoiQW5pa290b1RWIn0= */
/* NUVIO_GLOBAL_PROVIDER_BRANDING_V1:869994f22c6a */
;(function(g,c){"use strict";
function slot(v){if(Array.isArray(v))return{key:null,list:v};if(v&&typeof v==="object"){for(var i=0;i<3;i++){var k=["streams","results","data"][i];if(Array.isArray(v[k]))return{key:k,list:v[k]}}}return null}
function rebuild(v,x,list){if(x.key===null)return list;var o=Object.assign({},v);o[x.key]=list;return o}
...
var ok=false;try{if(typeof module!=="undefined"&&module.exports){ok=install(module.exports,"getStreams")||install(module.exports,"streams")}}catch(_e){}try{if(g&&typeof g.getStreams==="function"){if(ok&&typeof module!=="undefined"&&module.exports)g.getStreams=module.exports.getStreams;else install(g,"getStreams")}}catch(_e){}
})(typeof globalThis!=="undefined"?globalThis:this,{"providerId":"anikototv","providerName":"AnikotoTV","providerEmoji":"📺","implementationRevision":"post-presentation-lossless-source-label-v8"});
